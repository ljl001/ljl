...
<a href="../index.php?r=admin/nodeadd"  class="btn button_btn bg-deep-blue" title="添加管理员"><i class="fa  fa-edit"></i>&nbsp;添加权限</a>
...
<div class="compete_list">
       <table id="sample_table" class="table table_list table_striped table-bordered dataTable no-footer">
		 <thead>
	        ...
	        <div>
			     <a href="../index.php?r=admin/show_node&page=0" class="btn button_btn btn-danger">首页</a>
			     <a href="../index.php?r=admin/show_node&page=<?=$page-1?>" class="btn button_btn btn-danger">上一页</a>
			     <a href="../index.php?r=admin/show_node&page=<?=$page+1?>" class="btn button_btn btn-danger">下一页</a>
			     <a href="../index.php?r=admin/show_node&page=<?=$pagesum?>" class="btn button_btn btn-danger">尾页</a>
			 </div>
     </div>
     </div>
</div>
